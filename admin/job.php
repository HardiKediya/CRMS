    ...
    <div class="main-body">
        ...
        <div class="filter-option" style="display: flex;">
            <div class="col1" style="display: flex;">
                ...
                <select class="form-select w-50 " id="company" aria-label="Default select example">
            ...
            <div class="col1" style="display: flex;">
                ...
                <select class="form-select w-50 " id="category" aria-label="Default select example">
                    <option value="all" selected>All</option>
            ...
            <div class="col1" style="display: flex;">
                ...
                <select class="form-select w-50 " id="type" aria-label="Default select example">
                    <option value="all" selected>All</option>
            ...
            <div class="col1" style="display: flex;">
                <button type="button" class="btn btn-dark" onclick="fetchAlldata()">Search</button>
            </div>
        </div>
    </div>
        ...
        <div class="card mb-3" style="max-width: 100%; padding-bottom: 10px; margin: auto;">
            <div class="row g-0">
                <div class="col-md-4" style="display: flex; justify-content: center;">
                    <img src="../recruiter/company logo/bisag.png" class="img-fluid rounded-start"
                        style="width: 220px; height: auto;" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="container">
...
<script>
    ...
    function fetchAlldata() {
        ...
        XRH.onload = function() {
            var recruiter = this.responseText;
            ...
            for (let job of recruiter) {
                tabledata +=
                    ...
                    job.companyLogo +
                    '" class="img-fluid rounded-start"style="display : block; width : 75%; height: auto; margin:auto;" alt="..."></div><div class="col-md-8"><div class="container"><div class="row " id="row1" style="padding-top: 10px;"><div class="col-sm"><p class="card-text" id="jname"><b>Job Title : </b>' +
