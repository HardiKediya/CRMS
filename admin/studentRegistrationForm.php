...
<body>
    ...
    height: auto;">
                            <a class="nav-link" href="#" id="image-link">
                                <img src="img/profile_pic.png" id="image-1" style="width: 40px; height: auto;"
                                    alt=""></a>
    ...
    <!-- Design Form Section -->
    <h2 style=" color:#7B523B ; margin: 4% 0px 0px 7%;">Student Registration</h2>
    <style>
    ...
    <div class="form-box">
        ...
        <div class="row-2">
            <div class="section-3">
                ...
                <div class="txt_field">
                    <input type="number" name="cgpa" id="cgpa" autocomplete="off" required>
                    <span></span>
