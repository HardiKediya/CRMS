...
<body>
    ...
    <div class="filter-option" style="display: block; background-color: none;">
        <div class="button-section">
            <a class="btn btn-primary" href="studentRegistrationForm.php" role="button" style="margin-bottom: 10px;">Add
                Student</a>
            <a class="btn btn-primary" href="#" role="button" style="margin-bottom: 10px;"
