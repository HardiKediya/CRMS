    ...
    <div class="main-body">
        ...
        <div class="filer-option">
            <div class="col1" style="display: flex;">
                ...
                <select class="form-select w-50 " id="type" aria-label="Default select example" onchange="fetchAlldata()">
            ...
            <div class="col1">
                <a class="btn btn-primary" style="float: right; text-decoration: none; color: white;" href="jobForm.php" role="button">Add New Job</a>
            ...
            <!-- <div class="card mb-3" style="max-width: 100%; padding-bottom: 10px; margin: auto;">
                <div class="row g-0">
                    <div class="col-md-4" style="display: flex; justify-content: center;">
                        <img src="./company logo/bisag.png" class="img-fluid rounded-start"
